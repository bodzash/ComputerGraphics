...
texturec -f ./Assets/DuelIndicator_Diff.png -o ./build/Debug/DuelIndicator_Diff.dds --mips -t RGB8
texturec -f ./Assets/DuelIndicator_Spec.png -o ./build/Debug/DuelIndicator_Spec.dds --mips -t RGB8
